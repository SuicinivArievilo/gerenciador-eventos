...
export default function Eventos() {
  ...
  return (
    <div>
      ...
      {eventos?.map((evento) => (
        <CardsEventos key={evento._id} tituloEvento={evento.nome} dataEvento={evento.data} localEvento={evento.local} categEvento={evento.categoria} hrefBtn='/descricao' nomeBtn='Visualizar' tipoBtn='submit' formBtn='btn btn-lg m-1 btn-primary' />
      ))}
